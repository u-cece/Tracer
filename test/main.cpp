...
int main()
{
    ...
    std::unique_ptr front = std::make_unique<Plane>(glm::vec3(0.0f, 0.0f, 2.0f), glm::vec3(0.0f, 0.0f, -1.0f));
    ...
    std::unique_ptr sphere1 = std::make_unique<Sphere>(glm::vec3(-0.2f, 0.2f, 1.5f), 0.2f);
    sphere1->SetMaterial(specularRed);
    std::unique_ptr sphere2 = std::make_unique<Sphere>(glm::vec3(0.4f, 0.4f, 1.0f), 0.4f);
    sphere2->SetMaterial(white);

    std::unique_ptr emissive = std::make_unique<Sphere>(glm::vec3(0.0f, 1.0f, 2.0f), 1.0f);
